...
const columns: GridColDef[] = [
  { field: 'id', headerName: 'Capsule ID' },
  { field: 'customer', headerName: 'Serial', width: 200 },
  { field: 'date', type: 'date', headerName: 'Date launched' },
  { field: 'status', headerName: 'Status' },
  {
    ...
    headerName: 'Type',
    valueGetter: ({ row }) => {
      const subtotal = row.products.reduce((acc: number, product: any) => product.unitPrice * product.quantity, 0);
